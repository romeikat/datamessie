package com.romeikat.datamessie.dao.query.entity.execute.entityWithId;
...
public class EntityWithIdQueryUniqueForProjectionExecutor<E extends EntityWithId>
    extends EntityQueryUniqueForProjectionExecutor<E> {

  private final IdRestrictionsDecider idRestrictionsDecider;

  public EntityWithIdQueryUniqueForProjectionExecutor(final SharedSessionContract ssc,
