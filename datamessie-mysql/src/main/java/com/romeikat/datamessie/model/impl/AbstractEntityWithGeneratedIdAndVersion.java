...
public abstract class AbstractEntityWithGeneratedIdAndVersion
  ...
  public AbstractEntityWithGeneratedIdAndVersion() {}

  public AbstractEntityWithGeneratedIdAndVersion(final long id) {
    this.id = id;
  }
  ...
  @GenericGenerator(name = "assigned-identity",
      strategy = "com.romeikat.datamessie.model.util.AssignedIdentityGenerator")
