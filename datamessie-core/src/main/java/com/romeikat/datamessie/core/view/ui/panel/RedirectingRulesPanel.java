...
public class RedirectingRulesPanel extends DynamicListViewPanel<RedirectingRuleDto> {

  private static final long serialVersionUID = 1L;

  public RedirectingRulesPanel(final String id, final IModel<List<RedirectingRuleDto>> itemsModel) {
    super(id, itemsModel);
  }
  ...
  @Override
  protected RedirectingRuleDto newItem() {
    return new RedirectingRuleDto();
  }
