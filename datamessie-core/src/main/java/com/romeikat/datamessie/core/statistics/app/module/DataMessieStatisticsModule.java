package com.romeikat.datamessie.core.statistics.app.module;
...
@Component
public class DataMessieStatisticsModule extends AbstractDataMessieModule {
  ...
  @Autowired
  private IStatisticsManager localStatisticsManager;
  ...
  protected Collection<ISharedBean> getSharedBeans() {
    return Lists.newArrayList(localStatisticsManager);
  }
