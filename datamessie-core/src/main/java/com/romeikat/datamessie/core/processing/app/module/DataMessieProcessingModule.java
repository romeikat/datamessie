package com.romeikat.datamessie.core.processing.app.module;
...
@Component
public class DataMessieProcessingModule extends AbstractDataMessieModule {
  ...
  protected Collection<ISharedBean> getSharedBeans() {
    return Lists.newArrayList(localFullTextSearcher);
  }
