...
public class EntityQueryListIdsOfPropertyExecutor<E extends Entity> extends AbstractEntityQueryExecutor<E, List<Long>> {

  private final String propertyName;

  public EntityQueryListIdsOfPropertyExecutor(final SharedSessionContract ssc, final EntityQuery<E> query,
  ...
  protected Criteria buildCriteria(final SharedSessionContract ssc) {
    ...
    applyOrderForProperty(query.getOrders(), propertyName, criteria);
