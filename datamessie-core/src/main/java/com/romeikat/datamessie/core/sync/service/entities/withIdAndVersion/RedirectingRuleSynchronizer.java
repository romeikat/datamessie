...
public class RedirectingRuleSynchronizer extends EntityWithIdAndVersionSynchronizer<RedirectingRule> {
  ...
  @Override
  protected void copyProperties(final RedirectingRule source, final RedirectingRule target) {
  ...
  @Override
  protected EntityWithIdAndVersionDao<RedirectingRule> getDao(final ApplicationContext ctx) {
    return ctx.getBean(RedirectingRuleDao.class);
  }
