...
public class EntityWithIdQueryListObjectsExecutor<E extends EntityWithId> extends EntityQueryListObjectsExecutor<E> {

  private final IdRestrictionsDecider idRestrictionsDecider;

  public EntityWithIdQueryListObjectsExecutor(final SharedSessionContract ssc, final EntityWithIdQuery<E> query) {
    super(ssc, query);
