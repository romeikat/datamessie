...
public class BarEntity implements com.romeikat.datamessie.core.domain.entity.Entity {
  ...
  public BarEntity(final String name, final boolean active, final long fooId) {
    this.name = name;
    this.active = active;
    this.fooId = fooId;
  }
  ...
  public BarEntity setName(final String name) {
    this.name = name;
    return this;
  }
  ...
  public BarEntity setActive(final boolean active) {
    this.active = active;
    return this;
  }
  ...
  public BarEntity setFooId(final long fooId) {
    this.fooId = fooId;
    return this;
  }
