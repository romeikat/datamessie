...
@Repository
public class FooEntityWithGeneratedIdDao extends AbstractEntityWithIdDao<FooEntityWithGeneratedId> {

  public FooEntityWithGeneratedIdDao() {
    super(FooEntityWithGeneratedId.class);
  }
