...
public class DocumentFilterSettingsQueryTest extends AbstractDbSetupBasedTest {
  ...
  protected Operation initDb() {
    ...
    final Source source11 =
        new Source(11, "Source11", "http://www.source11.de/", null, null, true, true, false);
    final Source source12 =
        new Source(12, "Source12", "http://www.source12.de/", null, null, true, false, false);
    final Source source21 =
        new Source(21, "Source21", "http://www.source21.de/", null, null, true, true, false);
    final Source source22 =
        new Source(22, "Source22", "http://www.source22.de/", null, null, true, false, false);
    ...
    final Project project2 = new Project(2, "Project2", false, false);
